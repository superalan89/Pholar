package com.hooooong.pholar.view.custom;
...
public class MoreTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    private Pattern mHyperLinksPattern = Pattern.compile("\\b(https?)://[-a-zA-Z0-9+&@#/%?=~_|!:,.;]*[-a-zA-Z0-9+&@#/%=~_|]");
     ...
     * {@link MoreTextView} objects from your own code.
     *
     * @param context
     */
    ...
    public MoreTextView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mIsLinkable = a.getBoolean(R.styleable.MoreTextView_isLinkable, true);
            mIsEndEllipsable = a.getBoolean(R.styleable.MoreTextView_isEndEllipsable, true);
            mMaxLines = a.getInt(R.styleable.MoreTextView_maxLines, 5);
            mText = a.getString(R.styleable.MoreTextView_text);
        } finally {
    ...
    private class InternalMoreSpan extends ClickableSpan {
        ...
        public void updateDrawState(TextPaint tp) {
            ...
            tp.setColor(getResources().getColor(R.color.colorSliver));
            tp.setTextSize(48);
        }
